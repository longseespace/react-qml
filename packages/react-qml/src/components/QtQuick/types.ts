...
columnsMoved: Signal<Function>;
  ...
  export type QAbstractListModel = {
...
changed: Signal<Function>;
  ...
  export type QQmlDelegateModelParts = {
...
moveCurrentIndexRight(): void;
  ...
  export type QQuickGridViewAttached = {
...
footerPositioningChanged: Signal<Function>;
  ...
  export type QQuickListViewAttached = {
...
to: number | undefined;
  ...
  export type QQuickOpacityAnimator = {
...
textureSize: any;
  ...
  export type QQuickParallelAnimation = {
...
value: number | undefined;
  ...
  export type QQuickPathCatmullRomCurve = {
...
zScale: number | undefined;
  ...
  export type QQuickScaleAnimator = {
...
scriptName: string | undefined;
  ...
  export type QQuickSequentialAnimation = {
...
readonly transitions: QQuickTransition;
  ...
  export type QQuickStateOperation = {
...
fontInfoChanged: Signal<Function>;
  ...
  export type QQuickTextDocument = {
...
deselect(): void;
isRightToLeft(start: number | undefined, end: number | undefined): boolean | undefined;
cut(): void;
copy(): void;
paste(): void;
undo(): void;
...
moveCursorSelection(pos: number | undefined, mode: QQuickTextEdit_SelectionMode | string): void;
getText(start: number | undefined, end: number | undefined): string | undefined;
getFormattedText(start: number | undefined, end: number | undefined): string | undefined;
linkAt(x: number | undefined, y: number | undefined): string | undefined;
...
moveCursorSelection(pos: number | undefined): void;
moveCursorSelection(pos: number | undefined, mode: QQuickTextInput_SelectionMode | string): void;
inputMethodQuery(query: any, argument: any): any;
getText(start: number | undefined, end: number | undefined): string | undefined;
